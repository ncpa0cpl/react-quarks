...
export declare type ParseSingleAction<A> = A extends (arg_0: any, ...args: infer ARGS) => infer R ? (...args: ARGS) => FinalReturnType<R> extends Promise<any> ? Promise<void> : Promise<any> extends FinalReturnType<R> ? Promise<void> | void : void : never;
